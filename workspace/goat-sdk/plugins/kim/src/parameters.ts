...
export const pathSchema = z.object({
  ...
  intermediateTokens: z
    .array(z.string())
    .describe('Addresses of the intermediate tokens in the path'),
...
export class ExactOutputSingleParams extends createToolParameters(
  z.object({
    ...
    amountOut: z
      .string()
      .describe(
        'The amount of tokens to swap out in base units of the output token',
      ),
    amountInMaximum: z
      .string()
      .describe(
        'The maximum amount of tokens to swap in base units of the input token',
      ),
    limitSqrtPrice: z.string().describe('The limit price for the swap'),
  }),
) {}
